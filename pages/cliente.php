                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= substr_replace($value->tipo, (strlen($value->tipo) > 30 ? '...' : ''),30);; ?></td>
                                    <td><a href="./API/views/cliente.php?id=<?= $value->id; ?>&acao=buscar"><button type="button" class="btn btn-warning btn-sm">Visualizar/Editar</button></a>
